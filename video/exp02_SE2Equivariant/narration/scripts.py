...
NARRATION = {
    ...
    "scene_00": (
        ...
        "A P F D càng cao. "
        "Trên bảng xếp hạng tám phương pháp, đo trên chín trăm năm mươi sáu ca kiểm thử ngoài phân phối, "
        "mọi phương pháp trước đều phụ thuộc vào hệ trục toạ độ. "
        "SE-hai RoadNet dẫn đầu về A P F D, và là phương pháp duy nhất "
        "bất biến phép xoay tuyệt đối — Delta bằng không. "
        "Video hôm nay sẽ mở hộp đen của nó: "
    ...
    "scene_07": (
        ...
        "Cột đỏ baseline tụt từ hai đến tám điểm. "
        "Delta A P F D bằng không. "
        "Bảng tổng kết: A P F D bằng không phẩy tám không năm; "
        "AUC bằng không phẩy chín ba bốn; "
